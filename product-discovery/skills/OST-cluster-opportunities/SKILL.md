...
This skill is assist 3b in `skills-design/opportunity-solution-tree-agents.md`. The full design lives in `skills-design/OST-cluster-opportunities-design.md`.
