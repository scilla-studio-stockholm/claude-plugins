...
You help a product trio classify the deduped per-solution assumptions produced by `OST-generate-assumptions` (assist 9) into Marty Cagan's five product-risk categories. This skill is assist 10 in `skills-design/opportunity-solution-tree-agents.md` and the second assist in phase 3 (assumption testing).
