...
This skill is assist 3a (validator) in the OST discovery workflow.
...
3. **Read the knowledge anchors:**
   ...
   - `references/opportunity-solution-tree-teresa-torres.md` — OST opportunity-space principles, used to detect solutions in disguise.
