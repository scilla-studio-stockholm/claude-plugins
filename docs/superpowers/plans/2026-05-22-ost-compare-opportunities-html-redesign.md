...
- [ ] **Step 4: Update the "Write to Miro" line in the `## What this skill does NOT do` section.**
...
Run: `grep -n "scannable at 96 opportunities\|swim-lane columns\|Three artifacts, one render\|JSON + markdown + HTML only" product-discovery/skills/OST-compare-opportunities/SKILL.md`
Expected: four hits, one per edit.
